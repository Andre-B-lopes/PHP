...
<p class="texto-index">Digite o Nome de Guerra dos alunos, na ordem em que será realizada as apresntações:</p>
<form action="professor.php" method="post">
<input type="text" name="nome" class="texto-index" style='text-transform:uppercase'><br><br>
