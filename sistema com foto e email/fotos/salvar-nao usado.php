...
$stmt = $pdo->prepare('INSERT INTO fotos_'.$condominio.' (nome, conteudo, tipo, tamanho) VALUES (:nome, :conteudo, :tipo, :tamanho)');
...
echo "<script> window.location = 'upload_data.php?desc=".$desc."&coment=".$coment."&cond=".$condominio."';</script>";